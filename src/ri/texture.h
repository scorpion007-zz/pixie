...
public:
	...
	virtual float		lookupz(float u,float v,float z,const CTextureLookup *lookup,int thread)					=	0;
	virtual	void		lookup(float *dest,float u,float v,const CTextureLookup *lookup,int thread)					=	0;
	virtual	void		lookup4(float *dest,const float *u,const float *v,const CTextureLookup *lookup,int thread)	=	0;
...
public:
	...
	virtual	void		lookup(float *dest,const float *D0,const float *D1,const float *D2,const float *D3,const CTextureLookup *lookup,int thread)	=	0;
