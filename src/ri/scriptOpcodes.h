...
DEFOPCODE(Movess	,"movess"	,2,	OPERANDS2EXPR_PRE(const char **,const char **),SUNARYEXPR,OPERANDS2EXPR_UPDATE(1,1),		NULL_EXPR,0)
...
DEFOPCODE(VUString	,"vustring"	,2,	OPERANDS2EXPR_PRE(const char **,const char **),SUNARYEXPR,OPERANDS2EXPR_UPDATE(1,0),		NULL_EXPR,0)
#undef OPERATION
