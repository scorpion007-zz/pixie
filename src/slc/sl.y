...
%type<node>			slFunctionParameterList
%type<node>			slFunctionParameters
%type<node>			slFunctionParameter
%type<node>			slFunctionParameterIdentifierList
%type<integer>		slShaderType
%type<node>			slShaderParameterList
%type<node>			slShaderParameters
%type<node>			slShaderParameter
%type<node>			slShaderParameterInitializer
%type<node>			slShaderParameterIdentifierToken
%type<node>			slShaderParameterIdentifierList
%type<node>			slBlock
%type<node>			slVariableInitializer
%type<node>			slVariableDeclerations
%type<node>			slVariableIdentifierList
%type<node>			slVariableIdentifierTail
%type<node>			slStatement
%type<node>			slStatements
%type<node>			slMatchedStatement
%type<node>			slUnmatchedStatement
%type<node>			slBreakStatement
%type<node>			slContinueStatement
%type<node>			slReturnStatement
%type<node>			slWhileStartStatement
%type<node>			slWhileStatement
%type<node>			slUnmatchedWhileStatement
%type<node>			slAssignmentStatement
%type<node>			slUpdateStatement
%type<node>			slForStatement
%type<node>			slUnmatchedForStatement
%type<node>			slForInitStatement
%type<node>			slForInitStatements
%type<node>			slForCheckStatement
%type<node>			slForIncrementStatement
%type<node>			slForIncrementStatements
%type<node>			slMatchedIfStatement
%type<node>			slUnmatchedIfStatement
%type<node>			slGatherParameterList
%type<node>			slGatherHeader
%type<node>			slMatchedGatherStatement
%type<node>			slUnmatchedGatherStatement
%type<node>			slIlluminanceStatement
%type<node>			slUnmatchedIlluminanceStatement
%type<node>			slIlluminateStatement
%type<node>			slUnmatchedIlluminateStatement
%type<node>			slSolarStatement
%type<node>			slUnmatchedSolarStatement
%type<node>			slArrayItems
%type<node>			slArrayList
%type<node>			slAritmeticExpression
%type<node>			slAritmeticTerminalValue
%type<node>			slAritmeticTypeCast
%type<node>			slBooleanExpression
%type<node>			slFunctionCall
%type<node>			slFunctionCallParameters
%type<string>		slFunCallHeader
%type<node>			slFunCall
%type<string>		slTextureName
%type<string>		slTextureCall
%type<node>			slTextureNameSpecifier
%type<node>			slTextureChannelSpecifier
%expect				12
%%
slStart:		
		////////////////////////////////////////////////
